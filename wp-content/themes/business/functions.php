...
function custom_postgallery_type() {
...
// Set UI labels for Custom Post Type
	$labels = array(
		...
		'menu_name'           => __( 'Gallery', 'twentythirteen' ),
		'parent_item_colon'   => __( 'Parent Gallery', 'twentythirteen' ),
		'all_items'           => __( 'All Gallery', 'twentythirteen' ),
		'view_item'           => __( 'View Gallery', 'twentythirteen' ),
...
// Set other options for Custom Post Type
	...
	$args = array(
		'label'               => __( 'Gallery', 'twentythirteen' ),
		'description'         => __( 'Gallery news and reviews', 'twentythirteen' ),
		'labels'              => $labels,
...
add_action( 'init', 'custom_postgallery_type', 0 );
